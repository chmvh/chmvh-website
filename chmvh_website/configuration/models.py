...
class PracticeInfo(SingletonModel):
    accepting_clients = models.BooleanField(
        default=False,
        help_text=(
            "This affects the text displayed on the 'Hours and Area' " "page."
        ),
    ...
    accepting_clients_text = models.TextField(
        ...
        default="",
        help_text=(
            "This text is displayed on the 'Hours and Area' page when "
    ...
    email = models.EmailField(
        blank=True, default="", verbose_name="practice email"
    )
